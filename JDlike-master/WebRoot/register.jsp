			...
			<div id="register">
				<%
					if (error != null) {
						...
						} else if (error.equals("nameorpwempty")) {
							out.println("<div style='font-size:15px;margin:3px 0 3px 1px;color:red;'>用户名或密码不能为空!</div>");
				...
				<form action="Regist" method="post">
					...
					<div class="row3">
						<span> <input type="checkbox" name="agree" value="false">
